...
class EditDetailData extends StatefulWidget {
  final MapEntry<String, dynamic>? data; // 前の画面から受け取る値
  EditDetailData({this.data});

  @override
  State<EditDetailData> createState() => _EditDetailData();
}

class _EditDetailData extends State<EditDetailData> {
// ===数量単位の一覧===
