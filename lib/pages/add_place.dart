...
// ＝＝＝メイン＝＝＝
  ...
  Widget build(BuildContext context) {
    ...
    _dataProvider.data["places"]?.forEach((key, v) =>
                ...
                TextField(
                  ...
                  onTap: () async {
                    final DateTime? picked = await showDatePicker(
                      ...
                      lastDate:
                          DateTime(_addDate.year, _addDate.month, _addDate.day),
                    );
                    if (picked != null) {
                      setState(() {
                        _addDate = picked;
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          ...
                          items: [
                            ...
                            DropdownMenuItem(value: "パック", child: Text("パック")),
                            DropdownMenuItem(value: "食", child: Text("食")),
                            DropdownMenuItem(value: "皿", child: Text("皿")),
                ...
                onPressed: isValid
                    ? () {
                        ...
                        newData[_uuid] = {
                          ...
                          "addDate": DateFormat("yyyy-MM-dd").format(_addDate),
                          "expDate": DateFormat("yyyy-MM-dd").format(_expDate),
